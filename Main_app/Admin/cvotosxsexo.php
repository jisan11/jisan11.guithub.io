...
<head>
 ...
 ['Browser', 'Visits'],
 <?php 
 $query = "SELECT DISTINCT sexo, COUNT(sexo) as total FROM votante WHERE estado = 'Correcto' AND id_candidato = '$id' GROUP BY sexo";

 $exec = mysqli_query($con,$query);
 while($row = mysqli_fetch_array($exec)){

 echo "['".$row['sexo']."',".$row['total']."],";
 }
 ?>
 ]);

 var options = {
 title: 'Estadísticas de Votos por Genero'
 };
						...
						<div class="col">
							<div class="col-xs-12">
								<section id="tipos-repuestos">
									<h3 class="highlighted">Reporte Votos por Genero TSE 2017</h3>
