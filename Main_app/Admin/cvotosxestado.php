...
<head>
 ...
 ['Browser', 'Visits'],
 <?php 
 $query = "SELECT DISTINCT estado, COUNT(estado) as total FROM votante WHERE estado = 'Nulo' AND id_candidato = '$id' GROUP BY estado";
 ...
 var options = {
 title: 'Estadísticas de Votos Nulos'
 };
						...
						<div class="col">
							<div class="col-xs-12">
								<section id="tipos-repuestos">
									<h3 class="highlighted">Reporte Votos Nulos TSE 2017</h3>
